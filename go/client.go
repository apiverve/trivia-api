// Package trivia provides a Go client for the Trivia Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/trivia?utm_source=go&utm_medium=readme
package trivia
...
const (
	baseURL        = "https://api.apiverve.com/v1/trivia"
	defaultTimeout = 30 * time.Second
)

// Client is the Trivia Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Trivia Generator API client.
...
// Execute makes a request to the Trivia Generator API with typed parameters.
//
