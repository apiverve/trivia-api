...
```gradle
dependencies {
    implementation 'com.github.apiverve:trivia-api:1.1.12'
}
```
...
```java
import com.apiverve.trivia.TriviaGeneratorAPIClient;
import com.apiverve.trivia.APIResponse;
import com.apiverve.trivia.APIException;

// Initialize the client
TriviaGeneratorAPIClient client = new TriviaGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/trivia](https://docs.apiverve.com/ref/trivia)
...
- **Documentation:** [https://docs.apiverve.com/ref/trivia](https://docs.apiverve.com/ref/trivia)
- **Issues:** [GitHub Issues](https://github.com/apiverve/trivia-api/issues)
