...
class triviaWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/trivia');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/trivia';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"category":{"type":"string","required":false,"default":"general"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/trivia`);
        }
    }
