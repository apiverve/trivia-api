...
async function callTriviaGeneratorAPI() {
    try {
        ...
        const response = await fetch(`https://api.apiverve.com/v1/trivia?${params}`, {
            method: 'GET',
            headers: {
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/trivia](https://docs.apiverve.com/ref/trivia)

---

## Use Cases

Common use cases for the Trivia Generator API:
