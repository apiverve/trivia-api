# Trivia Generator API - Examples

This folder contains example code for using the Trivia Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/trivia',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/trivia");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/trivia](https://docs.apiverve.com/ref/trivia)
